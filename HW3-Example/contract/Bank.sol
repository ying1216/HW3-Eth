...
contract Bank {
    ...
    function buy(uint256 coinValue) public payable {
        uint256 value = coinValue * 1 ether;

        // require owner 的 coinBalance 不小於 value
        // your code
        require(coinBalance[owner] >= value, "owner doesnt have enough coin");

        // require msg.sender 的 etherBalance 不小於 value
        // your code
        require(balance[msg.sender] >= value,"you are not enough");
    ...
    function transferCoin(address to, uint256 coinValue) public {
        ...
        // your code
        require(coinBalance[msg.sender] >= value, "you dont have enough");
